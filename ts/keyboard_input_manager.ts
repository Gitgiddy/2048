module App {
    export class KeyboardInputManager {
        ...
        private emit(event: string, data?: any) {
            var callbacks: ((data: any) => void)[] = this.events[event];
            if (callbacks) {
        ...
        private listen() {
            ...
            document.addEventListener("keydown", event => {
                var modifiers = event.altKey || event.ctrlKey || event.metaKey ||
                    event.shiftKey;
                var mapped = (<any>map)[event.which];
            ...
            gameContainer.addEventListener(this.eventTouchstart, (event: TouchEvent) => {
            ...
            gameContainer.addEventListener(this.eventTouchend, (event: TouchEvent) => {
        ...
        private bindButtonPress(selector: string, fn: Function) {
